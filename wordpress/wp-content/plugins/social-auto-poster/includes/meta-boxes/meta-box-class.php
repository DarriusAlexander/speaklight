...
class Wpw_Auto_Poster_Meta_Box {
	...
	public function load_scripts_styles() {
		...
		if ( in_array( $typenow, $pages ) && $this->is_edit_page() ) {
			...
			$tw_tweet_exceed_message = sprintf( __('Twitter only allow %1$140 characters%2$ limit for the tweet. If the tweet message exceeds the limit it will be automatically truncated.', 'wpwautoposter'), '<strong>', '</strong>' );
