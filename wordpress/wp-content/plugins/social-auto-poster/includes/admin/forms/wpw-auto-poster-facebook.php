					...
					<div class="inside">
						...
						<table id="facebook-api-options" class="form-table wpw-auto-poster-facebook-api-options" style="width: 70%;">
							<tr>
								...
								<td>
									<input id="facebook_graph_api" type="radio" name="wpw_auto_poster_options[facebook_auth_options]" value="graph" <?php checked($facebook_auth_options, 'graph', true);?>><label for="facebook_graph_api"><?php _e( 'Facebook Graph API', 'wpwautoposter' ); ?></label></td>
								...
								<label for="facebook_rest_api"><?php _e( 'Facebook Mobile API', 'wpwautoposter' ); ?></label></td>
							</tr>
						</table>				
